    ...
    <div style={{ background: '#F5F0E8', minHeight: '100vh' }}>
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ padding: '56px 0' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 38, fontWeight: 400, letterSpacing: '-1px', marginBottom: 6, color: '#1C1A16' }}>
            Hoàng Anh Tuấn
          </h1>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 12, color: '#9A9895', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: 36 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', borderTop: '1px solid #DDD8CC' }}>
            {[
              ...
              <div key={i} style={{
                ...
                ...(i % 2 === 0 ? { paddingRight: 36, borderRight: '1px solid #DDD8CC' } : { paddingLeft: 36 }),
              }}>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: '#9A9895', textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: 6 }}>
                  {item.label}
                </div>
