...
export default function EditorPage() {
  ...
  async function handleSave(publish?: boolean) {
    ...
    // Fix excerpt: replace tags với space, collapse whitespace
    ...
    if (editId) {
      ...
      if (error) { console.error(error); setSaveMsg('Lỗi khi lưu!'); setSaving(false); return }
    } else {
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ padding: '32px 0' }}>
          ...
          <div style={{ marginBottom: 24 }}>
            <label style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: '#9A9895', letterSpacing: '1px', textTransform: 'uppercase', display: 'block', marginBottom: 8 }}>
              Thumbnail
            </label>
